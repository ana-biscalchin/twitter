...
(function(global, factory) {
  ...
  let defaultLocaleMonths = "January_February_March_April_May_June_July_August_September_October_November_December".split(
    "_"
  );
  ...
  let defaultLocaleMonthsShort = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split(
    "_"
  );
  ...
  let defaultLocaleWeekdays = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split(
    "_"
  );
  ...
  // substring from most specific to least, but move to the next array item if it's a more specific letiant than the current root
  ...
  function configFromRFC2822(config) {
    ...
    if (match) {
      let parsedArray = extractFromRFC2822Strings(
        match[4],
        match[3],
        match[2],
        match[5],
  ...
  function configFromStringAndArray(config) {
    let tempConfig, bestMoment, scoreToBeat, i, currentScore;
